package edu.uph.duasatusi.nicholasapp;
...
import edu.uph.duasatusi.nicholasapp.Adapter.ProdukAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Produk produk4 = new Produk("Pocari Sweat 500 ml", 9000, R.drawable.pocari);

        Produk produk5 = new Produk("Indomi Ayam Bawang 69g", 3100, R.drawable.indomie);
